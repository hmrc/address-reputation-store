...
private object AppDependencies {
  ...
  val compile = Seq(
    ...
    "uk.gov.hmrc" %% "reactivemongo" % "0.12.0" withSources(),
    "uk.gov.hmrc" %% "reactivemongo-bson" % "0.11.8" withSources() force(),
    "uk.gov.hmrc" %% "reactivemongo-bson-macros" % "0.11.8" withSources() force(),
